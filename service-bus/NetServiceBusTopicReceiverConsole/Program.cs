        ...
        public class Application : BackgroundService
        {
            ...
            protected override async Task ExecuteAsync(CancellationToken stoppingToken)
            {
                ...
                processor = client.CreateProcessor(
                    _configuration.GetValue<string>("ServiceBusTopic"),
                    _configuration.GetValue<string>("ServiceBusSuscription"),
            ...
            async Task MessageHandler(ProcessMessageEventArgs args)
            {
                ...
                Console.WriteLine(
                    $"Received: {body} from subscription: {_configuration.GetValue<string>("ServiceBusSuscription")}"
                );
